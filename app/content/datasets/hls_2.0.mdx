...
layers:
  - id: HLSL30_2.0_true_color
    ...
    tileApiEndpoint: "https://api.dev.veda.grss.cloud/titiler-cmr/WebMercatorQuad/tilejson.json"
  ...
  - id: HLSS30
    stacCol: HLS_S30_Nadir_BRDF_Adjusted_Reflectance
    name: HLS S30 (gibs)
    type: wmts
    stacApiEndpoint: https://api.dev.veda.grss.cloud/stac
    description: HLS S30
    sourceParams:
      layers: 1
      version: 1.3.0
  ...
  - id: HLSL30_2.0_ndvi
    ...
    stacApiEndpoint: "https://cmr.earthdata.nasa.gov/stac/LPCLOUD"
    tileApiEndpoint: "https://staging.openveda.cloud/api/titiler-cmr/WebMercatorQuad/tilejson.json"
    name: "HLS Landsat 8/9 NDVI"
    description: "Normalized Difference Vegetation Index (NDVI) from Landsat 8/9. NDVI = (NIR - Red) / (NIR + Red)"
    time_density: day
    zoomExtent:
      - 7
      - 18
  ...
  - id: HLSL30_2.0_ndti
    ...
    stacApiEndpoint: "https://cmr.earthdata.nasa.gov/stac/LPCLOUD"
    tileApiEndpoint: "https://staging.openveda.cloud/api/titiler-cmr/WebMercatorQuad/tilejson.json"
    name: "HLS Landsat 8/9 NDTI"
    description: "Normalized Difference Turbidity Index from Landsat 8/9 bands B04, B03"
    time_density: day
    zoomExtent:
      - 7
      - 18
  ...
  - id: HLSL30_2.0_nsmi
    ...
    stacApiEndpoint: "https://cmr.earthdata.nasa.gov/stac/LPCLOUD"
    tileApiEndpoint: "https://staging.openveda.cloud/api/titiler-cmr/WebMercatorQuad/tilejson.json"
    name: "HLS Landsat 8/9 NSMI"
    description: "Normalized Suspended Material Index from Landsat 8/9 bands B04, B03, B02"
    time_density: day
    zoomExtent:
      - 7
      - 18
    sourceParams:
      ...
      assets:
        ...
        - B03
        - B02
      expression: (B04+B03-B02)/(B04+B03+B02)
      minzoom: 7
      maxzoom: 18
      rescale: -1,1
      colormap_name: coolwarm
...
<Block>
  <Prose>
    <div style={{ border: '2px solid #2e7d32', padding: '10px', display: 'inline-block', color: 'black', backgroundColor: '#e8f5e9', marginBottom: '10px' }}>
      <span style={{ fontWeight: 'bold' }}>Attribution:</span> This dataset page content is sourced from <a href="https://www.earthdata.nasa.gov/dashboard/data-catalog/HLS_2.0" target="_blank" rel="noopener noreferrer">Earthdata VEDA</a>. Some imagery tiles are served via <a href="https://www.earthdata.nasa.gov/worldview" target="_blank" rel="noopener noreferrer">NASA Worldview GIBS</a>.
    </div>
