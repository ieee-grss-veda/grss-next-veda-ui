...
layers:
  ...
  - id: HLSL30_2.0_ndvi
    media:
      src: /images/dataset/hls_20241004_true_color.jpg
      alt: HLS L30 and S30 NDVI
    type: cmr
    stacCol: HLSL30_2.0
    stacApiEndpoint: "https://cmr.earthdata.nasa.gov/stac/LPCLOUD"
    tileApiEndpoint: "https://api.dev.veda.grss.cloud/titiler-cmr/WebMercatorQuad/tilejson.json"
    name: "HLS Landsat 8/9 NDVI"
    description: "NDVI from Landsat 8/9 bands B04, B05"
    time_density: day
    zoomExtent:
      - 7
      - 18
  ...
  - id: HLSL30_2.0_ndti
    ...
    description: "Normalized Difference Turbidity Index from Landsat 8/9 bands B03, B04"
    time_density: day
    zoomExtent:
      - 7
      - 18
  ...
  - id: HLSL30_2.0_nsmi
    ...
    description: "Normalized Suspended Material Index index from Landsat 8/9 bands B02, B03, B04"
    time_density: day
    zoomExtent:
      - 7
      - 18
