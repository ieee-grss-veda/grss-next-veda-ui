...
media:
  ...
  alt: lpjeosim data visualized on a map
taxonomy:
  - name: Topics
    values:
...
layers:
  - id: ch4-wetlands-emissions-m-ens
    stacCol: LPJ_EOSIM_L2_MCH4E.001
...
<Block>
  <Prose>
    ...
    <div style={{ border: '2px solid #2e7d32', padding: '10px', display: 'inline-block', color: 'black', backgroundColor: '#e8f5e9', marginTop: '10px' }}>
      <span style={{ fontWeight: 'bold' }}>Attribution:</span> This dataset page content and data are sourced from the <a href="https://earth.gov/ghgcenter/data-catalog/lpjeosim-wetlandch4-grid-v1" target="_blank" rel="noopener noreferrer">US GHG Center</a>.
    </div>
